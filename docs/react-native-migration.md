...
| 2   | Hub-ядро                                                    | 🔵 In progress | 1                            | BRANDBOOK native-patterns (Q9) ✅ #409. `ErrorBoundary` + `ModuleErrorBoundary` ✅ PR [#434](https://github.com/Skords-01/Sergeant/pull/434). Далі: Dashboard, OnboardingWizard, HubSettings, SyncStatusIndicator. Поки без HubChat / HubSearch / HubReports.                                                                                                                                                                                                        |
