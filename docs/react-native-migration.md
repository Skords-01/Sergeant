...
| 2    | 🔵 In progress | Підготовка частково зроблена: [#409](https://github.com/Skords-01/Sergeant/pull/409) додав секцію "Native Patterns" у `docs/BRANDBOOK.md` (Q9). **В роботі:** [PR-ERROR-BOUNDARY](https://github.com/Skords-01/Sergeant/pull/PR-ERROR-BOUNDARY) — `ErrorBoundary` + `ModuleErrorBoundary` Hub-core порт у `apps/mobile/src/core/`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
- `apps/mobile/src/core/ErrorBoundary.tsx` — top-level ErrorBoundary
  (PR [PR-ERROR-BOUNDARY](https://github.com/Skords-01/Sergeant/pull/PR-ERROR-BOUNDARY)).
...
- `apps/mobile/src/core/ModuleErrorBoundary.tsx` — per-module
  boundary (PR [PR-ERROR-BOUNDARY](https://github.com/Skords-01/Sergeant/pull/PR-ERROR-BOUNDARY)).
