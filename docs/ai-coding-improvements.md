...
| 2    | ✅ done            | 4/4 playbook-и створено: `add-feature-flag`, `cleanup-dead-code`, `hotfix-prod-regression`, `add-monobank-event-handler` |
...
## 2026-04-25 — закриття блоку 2 (playbooks)

| PR                                                     | Що                                                                                           | Блок |
| ------------------------------------------------------ | -------------------------------------------------------------------------------------------- | ---- |
| [#737](https://github.com/Skords-01/Sergeant/pull/737) | Додано `hotfix-prod-regression.md` + `add-monobank-event-handler.md`, оновлено README і мету | 2    |
