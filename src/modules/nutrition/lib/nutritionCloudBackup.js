...
export async function encryptJsonToBlob(payload, passphrase) {
  const enc = new TextEncoder();
...
export async function decryptBlobToJson(blob, passphrase) {
  const obj = blob && typeof blob === "object" ? blob : {};
