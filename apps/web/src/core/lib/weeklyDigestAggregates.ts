/**
 * Pure data-aggregation helpers for the weekly digest.
 *
 * No React, no hooks — only reads from localStorage and crunches numbers.
 * Kept separate from useWeeklyDigest.ts so the hook file stays focused on
