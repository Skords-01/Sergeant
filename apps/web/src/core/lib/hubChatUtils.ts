...
**📊 Аналітика**
• **Тренд витрат** — \`який тренд витрат за місяць?\`
• **Графік ваги** — \`покажи вагу за 3 місяці\`
• **Категорії витрат** — \`розбий витрати по категоріях\`
• **Аномалії** — \`чи є підозрілі витрати?\`
• **Тренд звичок** — \`чи покращується дисципліна?\`

**🛠 Утиліти**
• **1RM калькулятор** — \`який мій 1RM для жиму 80кг на 8?\`
• **Конвертер** — \`переведи 80 кг в фунти\`
• **Нотатка** — \`запиши: купити протеїн\`
• **Нотатки** — \`покажи мої нотатки\`
• **Експорт** — \`експортуй тренування\`

**🧠 Пам'ять**
• **Запам'ятати** — \`запам'ятай що я не їм глютен\`
• **Забути** — \`забудь про алергію на глютен\`
• **Профіль** — \`що ти про мене знаєш?\`
